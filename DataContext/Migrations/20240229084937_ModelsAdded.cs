    ...
    public partial class ModelsAdded : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationControllers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApplicationActions_ApplicationControllers_ApplicationControllerId",
                        column: x => x.ApplicationControllerId,
                        principalTable: "ApplicationControllers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Roles_AspNetRoles_ApplicationRoleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationActionId = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TimeStamp = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccessInRoles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AccessInRoles_ApplicationActions_ApplicationActionId",
                        column: x => x.ApplicationActionId,
                        principalTable: "ApplicationActions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccessInRoles_Roles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessInRoles_ApplicationActionId",
                table: "AccessInRoles",
                column: "ApplicationActionId");

            migrationBuilder.CreateIndex(
                name: "IX_AccessInRoles_RoleId",
                table: "AccessInRoles",
                column: "RoleId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationActions_ApplicationControllerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Roles_ApplicationRoleId",
                table: "Roles",
